            ...
            <div style={{display:this.props.projectShow}}>
                ...
                <div id='prj001' className='margin-97'>
                    ...
                    <Collapse defaultActiveKey={['p18']} ghost>
                        ...
                        <Panel className='font-bold' header="Cloud Storage App" key="p16">
                        ...
                        <Panel className='font-bold' header="Home Rent Website" key="p15">
                        ...
                        <Panel className='font-bold' header="Todo list" key="p14">
                            <p className='font-normal'>Express</p>
                            <p><a target='_blank' rel="noopener noreferrer" href='https://github.com/YizheZhang-Ervin/WebApp_WebDesignCourse'>Github</a></p>
                        </Panel>
                        <Panel className='font-bold' header="Online Spreadsheet" key="p13">
                            <p className='font-normal'>HTML/CSS/JS</p>
                            <p><a target='_blank' rel="noopener noreferrer" href='https://github.com/YizheZhang-Ervin/WebApp_WebDesignCourse'>Github</a></p>
                            <Image src={excel}></Image>
                        </Panel>
                        <Panel className='font-bold' header="Long Page Website" key="p12">
                            <p className='font-normal'>HTML/CSS/JS</p>
                            <p><a target='_blank' rel="noopener noreferrer" href='https://github.com/YizheZhang-Ervin/WebApp_WebDesignCourse'>Github</a></p>
                            <Image src={spa}></Image>
                        </Panel>
